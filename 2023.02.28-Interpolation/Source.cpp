...
int main()
{
	...
	while (t == 1)
	{
		...
		while (c != 1 and c != 0)
		{
			...
			{
				cout << "Введите точку интерполирования x > -1" << endl;
				cin >> x;
			}
		}
		n = m + 1;
		...
		cout << "Значение интерполяционного многочлена: " << s << endl;
		cout << "Значение абсолютной фактической погрешности: " << abs(func(x) - s) << endl;
